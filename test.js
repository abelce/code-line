...
var li = (t, e, r) =>
  e in t
    ? sn(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r })
    : (t[e] = r)
var on = (t, e) => {
...
var R = (t, e, r) => (
    un(t, e, 'read from private field'), r ? r.call(t) : e.get(t)
  ),
  Et = (t, e, r) =>
    e.has(t)
      ...
      : e.set(t, r),
  ln = (t, e, r, n) => (
    un(t, e, 'write to private field'), n ? n.call(t, r) : e.set(t, r), r
  )
var en = {}
on(en, {
  languages: () => xs,
...
function yt (t, e) {
  return !!(
    ...
    (me(t) &&
      t.children.some(r => r.type !== 'text' && r.type !== 'interpolation')) ||
...
function Hn (t, e) {
  ...
  switch (e.htmlWhitespaceSensitivity) {
    ...
    default:
      return (
        (t.type === 'element' && (!t.namespace || r || fe(t)) && bn[t.name]) ||
        wn
      )
  }
}
...
function Zn (t, e) {
  ...
  if (r.fullName === 'style' && !e.parentParser && !n.includes('{{'))
    return async s =>
      he(await s(n, { parser: 'css', __isHTMLStyleAttribute: !0 }))
}
var br = new WeakMap()
function ia (t, e) {
  let { root: r } = t
...
async function ua (t, e, { parseWithTs: r }) {
  ...
  try {
    ...
    if (
      ((n = s.cause) == null ? void 0 : n.code) !== 'BABEL_PARSER_SYNTAX_ERROR'
    )
      throw s
  }
  return T(
  ...
  let s =
    ...
    i =
      typeof s == 'boolean'
        ...
        : () => !1,
    a = t.map(
      ({ node: d }) => (i(d) ? B(e.originalText.slice(J(d), Z(d))) : r()),
      'attrs'
    ),
    o =
      n.type === 'element' &&
      ...
      if (!r.isSelfClosing && Tt(r, e)) {
        ...
        return n
          ? async (s, i) => {
              ...
              return (
                o ||
                  ((u = await s(Sr(a), { parser: n, __embeddedInHtml: !0 })),
                  (o = u === '')),
                [
                  G(r, e),
                  E(st(t, e, i)),
...
function Ds (t, e, r) {
  let { node: n } = t
  if (yt(n, e))
    return [G(n, e), E(st(t, e, r)), B(Nt(n, e)), ...tt(n, e), z(n, e)]
  let s =
      n.children.length === 1 &&
      ...
      for (let i = 0; i < r.length; i++) {
        ...
        u
          ...
          : (e.removeChild(a),
            i--,
            (o || p) &&
              (l && (l.hasTrailingSpaces = !0), f && (f.hasLeadingSpaces = !0)))
      }
...
function Ma (t, e) {
  t.walk(r => {
    ...
    if (n) {
      ...
      for (let s of n)
        (s.isLeadingSpaceSensitive = Fn(s, e)),
          (s.isTrailingSpaceSensitive = Nn(s, e))
  ...
  Vt = class extends Ht {
    ...
    hasElement (e, r) {
      return r.some(n => n.name === Fr.name) ||
        (e.indexOf('-') > -1 &&
          (Nr(e) || Pr(e) || r.some(n => n.name === Lr.name)))
        ? !0
  ...
  return (
    pt ||
      ...
      (pt = Object.assign(Object.create(null), {
        ...
        title: new m({
          contentType: { default: P.ESCAPABLE_RAW_TEXT, svg: P.PARSABLE_DATA }
        }),
        textarea: new m({
...
function Qs (t, e, r, n = {}) {
  ...
  return (
    s.tokenize(), new Vr(wo(s.tokens), s.errors, s.nonNormalizedIcuExpressions)
  )
}
var So = /\r\n?/g
function Ue (t) {
...
var ir = { attrs: !0, children: !0, cases: !0, expression: !0 },
  ...
  ze = class ze {
    constructor (e = {}) {
      ...
      lr(this, 'type')
      lr(this, 'parent')
      for (let r of new Set([...ti, ...Object.keys(e)]))
    ...
    map (e) {
      ...
      for (let n in ir) {
        ...
        if (s) {
          ...
          r !== s &&
            (r || (r = new ze({ parent: this.parent })), r.setProperty(n, i))
        }
      }
    ...
    for (let [x, U] of l.entries()) {
      ...
      if (tn === null) (f = y().errors), (l[x] = q(U))
        ...
        let rn = y().errors.find(
          nn =>
            nn.span.start.offset > ui.start.offset &&
            nn.span.start.offset < tn.end.offset
        )
        rn && si(rn), (l[x] = q(U))
      }
    }
